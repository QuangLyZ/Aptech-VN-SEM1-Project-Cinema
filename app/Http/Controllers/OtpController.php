...
class OtpController extends Controller
{
    ...
    public function sendOtp(Request $request)
    {
        ...
        try {
            Mail::send('emails.otp', ['otpCode' => $newOtpCode, 'userName' => $userData['name']], function ($message) use ($email) {
    ...
    public function verifyOtp(Request $request)
    {
        ...
        return back()->with('error', 'Mã OTP trật lất rồi sếp ơi! Kiểm tra lại email nha! 😅');
    }
}
