...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($moviesData as $data) {
            $movies[$data['name']] = Movie::updateOrCreate(
                ['name' => $data['name']],
                $data
            );
        }
        ...
        // ===================== CINEMAS =====================
         $cinemasData = [
            ...
            [
                ...
                'seats'    => 1200,
                'features' => ['IMAX', 'VIP'],
                'image'    => '/public/images/OIP2.jpg',
                'map'      => 'https://maps.app.goo.gl/e9dVD3wvPcT6nkoSA',
                'status'   => 'open',
            ],
            [
                'name'     => 'CineBook Giga Mall',
                'address'  => 'Tầng 6, Gigamall, 240-242 Phạm Văn Đồng',
                'district' => 'Thủ Đức',
                'phone'    => '123456',
                'hours'    => '09:00 – 23:00',
                'screens'  => 6,
        ...
        // ===================== SHOWTIMES =====================
        // Xoá showtimes cũ để tránh trùng
        Showtime::query()->delete();

        // Lịch chiếu: phim nào chiếu ở rạp nào, giờ nào
        // Format: ['TênPhim' => ['TênRạp' => ['HH:MM', ...], ...], ...]
        $schedule = [
            ...
            'Spider-Man: No Way Home' => [
                'CineBook Sư Vạn Hạnh' => ['08:00', '10:30', '13:00', '15:30', '18:30'],
                'CineBook Aeon Tân Phú' => ['09:00', '11:45', '14:15', '17:00', '20:00'],
                'CineBook Giga Mall'    => ['10:00', '12:30', '15:00', '18:00', '21:00'],
            ],
            'Dune: Part Two' => [
                'CineBook Landmark 81'  => ['10:30', '14:00', '17:30', '21:00'],
                'CineBook Giga Mall'    => ['09:00', '12:30', '16:00', '19:30', '22:30'],
            ],
        ];

        // Tạo showtimes cho 5 ngày tới
        foreach ($schedule as $movieName => $cinemaSchedule) {
            ...
            foreach ($cinemaSchedule as $cinemaName => $times) {
                ...
                $room = $rooms[$cinemaName][0] ?? null; // Dùng phòng 1
                if (!$room) continue;
