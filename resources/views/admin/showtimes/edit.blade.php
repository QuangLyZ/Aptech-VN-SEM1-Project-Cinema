...
<div class="max-w-2xl space-y-6 animate-[fadeIn_0.5s_ease-in-out]">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="admin-page-title font-extrabold tracking-tight text-white">Sửa Suất Chiếu</h2>
        ...
        <div class="rounded-3xl border border-gray-800 bg-gray-900/80 p-6 space-y-5">
            ...
            <div>
                ...
                <div class="relative group">
                    <input type="text" name="start_time" id="start_time_picker"
                           value="{{ old('start_time', $showtime->start_time?->format('Y-m-d H:i')) }}"
