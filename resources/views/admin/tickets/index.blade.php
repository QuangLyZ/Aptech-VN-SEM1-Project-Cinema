...
<div class="space-y-6 animate-[fadeIn_0.5s_ease-in-out]">
    ...
    <form method="GET" action="{{ route('admin.tickets.index') }}"
        ...
        <label class="flex flex-1 min-w-[200px] items-center gap-3 rounded-xl border border-gray-700 bg-black/40 px-4 py-2.5">
            <i class="fa-solid fa-magnifying-glass text-gray-500 text-sm"></i>
            <input type="text" name="q" value="{{ $filters['q'] ?? '' }}"
                   placeholder="Tìm tên, email, SĐT..."
                   class="w-full border-0 bg-transparent p-0 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-0">
        </label>
