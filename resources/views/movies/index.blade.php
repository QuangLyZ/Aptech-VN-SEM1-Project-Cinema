                ...
                >
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="mt-4">                    
                            ...
                            class="inline-flex items-center bg-transparent hover:bg-gray-800 text-white font-bold py-2 px-6 rounded-lg transition-colors border border-gray-600 w-fit text-sm">
